<%@ Page Title="Tiệm ăn vặt | Lịch sử đặt hàng" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="LichSuDonHang.aspx.cs" Inherits="TiemAnVat.LichSuDonHang" %>
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 20px;">
                <div class="col-sm-12" style="text-align: center;">
                    <asp:Label ID="LabelMenu" runat="server" Text="Lịch sử đặt hàng" CssClass="menu-label"></asp:Label>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server"  
                    ConnectionString="<%$ ConnectionStrings:TiemAnVatConnection %>"   
                    SelectCommand="SELECT * FROM DonHang"></asp:SqlDataSource>                
                </div>
                <div class="col-sm-12">
                    <asp:GridView ID="gvLSDH" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                        DataKeyNames="Id"
